...
constexpr uint32 ARENA_SLOT_SOLO_3v3 = 2; // 4 (need to match ARENA_TEAM_SOLO_3v3 to show the team)
constexpr uint32 BATTLEGROUND_QUEUE_3v3_SOLO = 12; // 12 BATTLEGROUND_QUEUE_5v5
